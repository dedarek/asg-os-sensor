...
验收批次：**ASG-BATCH-20260919-142944**；机器 01a329ad376e9a7f；Hook sha256:e55d586ecf77e37d8；配方 harness-efac4c5f21c6@rev7；模式 isolated_real_instance；关联会话 112 个（2 个实例）。
...
| --- | --- | --- | --- | --- | --- |
| Codex (PID 9601) | 2/10 | not_reached | not_reached | unsupported | not_reached |
